...
def run_network(model=None, X_train=None, X_label=None, X_test=None, X_test_label=None):
    ...
    np.savetxt('Insect_train_64D.txt', layer_output, fmt='%s')
    ...
    np.savetxt('Insect_test_64D.txt', layer_output_after, fmt='%s')
    ...
    np.savetxt('Insect_test_labels_predict.txt', predict_labels, fmt='%s')
...
np.savetxt('Insect_test_labels_truth.txt', X_test_label, fmt='%s')
