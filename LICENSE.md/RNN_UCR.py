...
def run_network(model=None, X_train=None, X_label=None, X_test=None, X_test_label=None):
    ...
    np.savetxt('FacesUCR_train_36D.txt', layer_output, fmt='%s')
    ...
    np.savetxt('FacesUCR_test_36D.txt', layer_output_after, fmt='%s')
    ...
    np.savetxt('FacesUCR_test_labels_predict.txt', predict_labels, fmt='%s')
...
np.savetxt('FacesUCR_test_labels_truth.txt', X_test_label, fmt='%s')
